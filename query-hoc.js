    ...
    return function (WrappedComponent) {
        ...
        var GraphQL = (function (_super) {
            ...
            GraphQL.prototype.render = function () {
                ...
                var opts = tslib_1.__assign({}, mapPropsToOptions(props));
                if (!opts.variables && operation.variables.length > 0) {
                    opts.variables = hoc_utils_1.calculateVariablesFromProps(operation, props);
                }
                console.log(opts);
                return (React.createElement(Query_1.default, tslib_1.__assign({}, opts, { displayName: graphQLDisplayName, skip: shouldSkip, query: document }), function (_a) {
